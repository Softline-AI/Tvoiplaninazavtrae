...
const Navigation: React.FC = () => {
  ...
  return (
    <nav className="nav-black flex z-40 w-full h-auto items-center justify-center sticky top-0 inset-x-0">
      <header className="z-40 flex px-6 gap-4 w-full flex-row relative flex-nowrap items-center justify-between h-16 max-w-7xl">
        <div className="flex items-center gap-8">
          <Link to="/" className="flex items-center gap-2">
            <div className="text-2xl font-extrabold text-white uppercase tracking-wider">STALKCHAIN</div>
          </Link>
          <div className="hidden sm:flex items-center gap-6">
            <div className="relative" ref={dropdownRef}>
              ...
              {isProductsOpen && (
                <div className="absolute top-full left-0 mt-2 w-[800px] card-black rounded-xl shadow-xl border border-black-border p-6 z-50">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        <Link to="/app/daily-trends" className="w-full flex items-start gap-2 p-2 rounded-lg hover:bg-black-border transition-all duration-200 text-left group">
                          <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-gray-700 rounded-md group-hover:bg-gray-600 transition-colors">
                            <svg aria-hidden="true" focusable="false" height="16" role="presentation" viewBox="0 0 24 24" width="16" className="w-5 h-5 text-white">
                              <path d="M21 10H17L14 19L8 1L5 10H1" stroke="currentColor" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg>
                          </div>
                          <div className="flex-1 overflow-hidden">
                            <div className="font-medium text-white text-sm leading-tight break-words">Daily Trends</div>
                            <div className="text-xs text-gray-400 leading-tight mt-0.5 break-words">Track the hottest tokens and market shifts every day</div>
                          </div>
                        </Link>
                        
                        <Link to="/app/top-tokens" className="w-full flex items-start gap-2 p-2 rounded-lg hover:bg-black-border transition-all duration-200 text-left group">
                          <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-gray-700 rounded-md group-hover:bg-gray-600 transition-colors">
                            <svg aria-hidden="true" focusable="false" height="20" role="presentation" viewBox="0 0 24 24" width="20" className="text-white">
                          ...
                          <div className="flex-1 overflow-hidden">
                            ...
                            <div className="text-xs text-gray-400 leading-tight mt-0.5 break-words">Monitor top-performing tokens by volume and smart money</div>
                          </div>
                        </Link>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        <Link to="/app/wallet-finder" className="w-full flex items-start gap-2 p-2 rounded-lg hover:bg-black-border transition-all duration-200 text-left group">
                          <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-gray-700 rounded-md group-hover:bg-gray-600 transition-colors">
                            <svg aria-hidden="true" focusable="false" height="16" role="presentation" viewBox="0 0 24 24" width="16" className="w-5 h-5 text-white">
                              <g fill="none" stroke="currentColor" strokeWidth="1.5">
                                <path d="M19 20H5a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2Z"></path>
                                <path d="M16.5 14a.5.5 0 1 1 0-1a.5.5 0 0 1 0 1" stroke="currentColor" fill="none"></path>
                          ...
                          <div className="flex-1 overflow-hidden">
                            ...
                            <div className="text-xs text-gray-400 leading-tight mt-0.5 break-words">Find and analyze any wallet. Uncover connections and holdings</div>
                          </div>
                        </Link>
                      </div>
                    </div>
            ...
            <a className="text-gray-300 hover:text-white transition-colors" href="#plans">
              Pricing
            </a>
          </div>
        </div>
        <div className="flex items-center gap-4">
          <a className="text-xs text-gray-300 hover:text-white transition-colors hover:underline" href="#">
            login
          </a>
          <Link 
            to="/app" 
            className="btn-primary-black inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all h-9 px-4 py-2"
          >
            Open App
          </Link>
        </div>
