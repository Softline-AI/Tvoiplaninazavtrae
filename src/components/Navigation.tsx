...
const Navigation: React.FC = () => {
  ...
  return (
    <nav className="flex z-40 w-full h-auto items-center justify-center sticky top-0 inset-x-0 beautiful-nav">
      <header className="z-40 flex px-6 gap-4 w-full flex-row relative flex-nowrap items-center justify-between h-16 max-w-7xl">
        <div className="flex items-center gap-8">
          <Link to="/" className="flex items-center gap-2">
            <div className="text-2xl font-bold text-blue-bright">SmartChain</div>
          </Link>
          <div className="hidden sm:flex items-center gap-6">
            <div className="relative" ref={dropdownRef}>
              <button 
                onClick={() => setIsProductsOpen(!isProductsOpen)}
                className="flex items-center gap-1 text-blue-main hover:text-blue-bright transition-colors"
              >
                Products
              ...
              {isProductsOpen && (
                <div className="absolute top-full left-0 mt-2 w-[800px] beautiful-card rounded-xl shadow-xl border border-gray-200 p-6 z-50 bg-white">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {/* KOL Screener */}
                    <div className="space-y-3">
                      <div className="mb-2">
                        <h3 className="font-semibold text-sm text-gray-900">KOL Screener</h3>
                      </div>
                      <div className="space-y-2">
                        <Link to="/app/kol-feed" className="w-full flex items-start gap-2 p-2 rounded-lg hover:bg-blue-900/20 transition-all duration-200 text-left group">
                          <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-blue-50 rounded-md group-hover:bg-blue-100 transition-colors">
                            <svg aria-hidden="true" focusable="false" height="16" role="presentation" viewBox="0 0 24 24" width="16" fill="none" className="w-5 h-5 text-primary">
                              <path d="M5 18h14M5 14h14l1-9-4 3-4-5-4 5-4-3 1 9Z" stroke="#3b82f6" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg>
                          </div>
                          <div className="flex-1 overflow-hidden">
                            <div className="font-medium text-gray-900 text-sm leading-tight break-words">KOL Feed</div>
                            <div className="text-xs text-gray-600 leading-tight mt-0.5 break-words">Real-time feed of top influencer trades and wallet activity</div>
                          </div>
                        </Link>
                        
                        <Link to="/app/kol-leaderboard" className="w-full flex items-start gap-2 p-2 rounded-lg hover:bg-blue-50 transition-all duration-200 text-left group">
                          <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-blue-50 rounded-md group-hover:bg-blue-100 transition-colors">
                    ...
                    <div className="space-y-3">
                      <div className="mb-2">
                        <h3 className="font-semibold text-sm text-gray-900">Smart Money Tracker</h3>
                      </div>
                      <div className="space-y-2">
                        <Link to="/app/daily-trends" className="w-full flex items-start gap-2 p-2 rounded-lg hover:bg-blue-50 transition-all duration-200 text-left group">
                          <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-blue-50 rounded-md group-hover:bg-blue-100 transition-colors">
                            <svg aria-hidden="true" focusable="false" height="16" role="presentation" viewBox="0 0 24 24" width="16" className="w-5 h-5 text-primary">
                              <path d="M21 10H17L14 19L8 1L5 10H1" stroke="#3b82f6" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg>
                          </div>
                          <div className="flex-1 overflow-hidden">
                            <div className="font-medium text-gray-900 text-sm leading-tight break-words">Daily Trends</div>
                            <div className="text-xs text-gray-600 leading-tight mt-0.5 break-words">Track the hottest tokens and market shifts every day</div>
                          </div>
                        </Link>
                    ...
                    <div className="space-y-3">
                      <div className="mb-2">
                        <h3 className="font-semibold text-sm text-gray-900">Solana Tools</h3>
                      </div>
                      <div className="space-y-2">
                        <Link to="/app/wallet-finder" className="w-full flex items-start gap-2 p-2 rounded-lg hover:bg-blue-50 transition-all duration-200 text-left group">
                          <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-blue-50 rounded-md group-hover:bg-blue-100 transition-colors">
                            <svg aria-hidden="true" focusable="false" height="16" role="presentation" viewBox="0 0 24 24" width="16" className="w-5 h-5 text-primary">
                              <g fill="none" stroke="currentColor" strokeWidth="1.5">
                                <path d="M19 20H5a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2Z"></path>
                                <path d="M16.5 14a.5.5 0 1 1 0-1a.5.5 0 0 1 0 1" stroke="#3b82f6" fill="none"></path>
                                <path d="M18 7V5.603a2 2 0 0 0-2.515-1.932l-11 2.933A2 2 0 0 0 3 8.537V9"></path>
                              </g>
                            </svg>
                          </div>
                          <div className="flex-1 overflow-hidden">
                            <div className="font-medium text-gray-900 text-sm leading-tight break-words">Wallet Finder</div>
                            <div className="text-xs text-gray-600 leading-tight mt-0.5 break-words">Find and analyze any wallet. Uncover connections and holdings</div>
                          </div>
                        </Link>
        ...
        <div className="flex items-center gap-4">
          <a className="text-gray-700 hover:text-primary transition-colors" href="#tools">
            Tools
          </a>
          <a className="text-xs text-blue-main hover:text-blue-bright transition-colors hover:underline" href="#">
            login
          </a>
          <Link 
            to="/app" 
            className="clean-button inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all h-9 px-4 py-2"
          >
            Open App
          </Link>
        </div>
