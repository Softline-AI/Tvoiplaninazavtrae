...
Приложение теперь использует Privy для аутентификации пользователей. Профили трейдеров доступны только после регистрации.
...
Откройте файл `.env` и замените `YOUR_PRIVY_APP_ID_HERE` на ваш реальный App ID:
